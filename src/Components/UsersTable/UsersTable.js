...
const UsersTable = () => {
    ...
    const handleDeleteUser = id => {
        ...
        if(proceed) {
            const url = `https://glacial-springs-97945.herokuapp.com/delete-user/${id}`;
            fetch(url, {
                method: 'DELETE'
            })
            .then(res => res.json())
                                                ...
                                                {users.map((user, count) => (
                                                    <div className="card--data" data-aos="fade-left" data-aos-duration="1000" key={user._id}>
                                                        <div className="row mb-4">
                                                            ...
                                                            <Col sm={5} xs={4} className="d-flex align-items-center justify-content-center">
